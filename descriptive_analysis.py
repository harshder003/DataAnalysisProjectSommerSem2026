...
def load_data(csv_file='cycling.csv'):
...
def create_visualizations(df):
    ...
    plt.tight_layout()
    plt.savefig('descriptive_barplot_mean_rider_class.png', dpi=300, bbox_inches='tight')
    print("Saved: descriptive_barplot_mean_rider_class.png")
    plt.close()
    ...
    ax.grid(True, alpha=0.3, axis='y')
    plt.tight_layout()
    plt.savefig('descriptive_barplot_interaction.png', dpi=300, bbox_inches='tight')
    print("Saved: descriptive_barplot_interaction.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('descriptive_heatmap_interaction.png', dpi=300, bbox_inches='tight')
    print("Saved: descriptive_heatmap_interaction.png")
    plt.close()
